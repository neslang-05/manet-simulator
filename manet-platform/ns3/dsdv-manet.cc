...
NS_LOG_COMPONENT_DEFINE("DsdvManet");
...
int main(int argc, char *argv[])
{
    ...
    std::string animFile    = "dsdv-animation.xml";
    ...
    NS_LOG_INFO("[DSDV] Nodes=" << nNodes << " SimTime=" << simTime
                << " Area=" << areaX << "x" << areaY);
    ...
    {
        anim.UpdateNodeDescription(nodes.Get(i), "DSDV-" + std::to_string(i));
    ...
    std::cout << "\n[DSDV] ===== Simulation Results =====" << std::endl;
    std::cout << "[DSDV] TX Packets   : " << g_tx       << std::endl;
    std::cout << "[DSDV] RX Packets   : " << g_rx       << std::endl;
    std::cout << "[DSDV] PDR          : " << pdr        << " %" << std::endl;
    std::cout << "[DSDV] Avg Throughput: "
              << (flowCount > 0 ? totalTp / flowCount : 0) << " kbps" << std::endl;
    std::cout << "[DSDV] Avg Delay    : "
              << (flowCount > 0 ? totalDelay / flowCount : 0) << " ms" << std::endl;
    std::cout << "[DSDV] Animation    : " << animFile   << std::endl;
    std::cout << "[DSDV] ====================================\n" << std::endl;
